...
#need callback for gradio
def  chat(message,history):
    history=[{"role":h["role"],"content":h["content"]} for h in history] # need this for other providers unless using openai... cz history in gradio has extra stufsf like metadata
